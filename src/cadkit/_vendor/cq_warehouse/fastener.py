# Modified by CadKit: private package imports and resource lookup.
"""
...
def read_fastener_parameters_from_csv(filename: str) -> dict:
    ...
    parameters = {}
    with pkg_resources.open_text(_package_name, filename) as csvfile:
...
def read_drill_sizes() -> dict:
    ...
    drill_sizes = {}
    with pkg_resources.open_text(_package_name, "drill_sizes.csv") as csvfile:
        reader = csv.DictReader(csvfile)
        fieldnames = reader.fieldnames
        for row in reader:
...
def lookup_nominal_screw_lengths() -> dict:
    ...
    with pkg_resources.open_text(_package_name, "nominal_screw_lengths.csv") as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
