...
The code uses CadKit 0.2.0 and the implemented `cadkit.design` namespace. This
namespace is experimental; its names may change in later releases. All six
chapters have complete, runnable example files. Follow along in one
`enclosure.py`, or use a chapter's example to restart at that point.
