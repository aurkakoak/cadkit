"""Chapter 6: the checked starting point for a scoped agent edit.

Task: change HEIGHT to 24, keep the rim at Z=0 and preserve the lid and mount.
Validate the assembly and export both parts after the change.
"""
